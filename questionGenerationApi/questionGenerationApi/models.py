...
class Question(models.Model):
    ...
    questionText = models.TextField(null=False, default='unset', help_text='Full question text')
    answer = models.TextField(null=False, default='unset', help_text='Full answer text')
